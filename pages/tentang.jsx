...
export default function Tentang() {
  ...
  return (
    <>
      <SEO
        title="Tentang Kami"
        description="Anugerah Sports Malang — Toko olahraga terpercaya sejak 1974. Authorized distributor Yonex, Victor, Li-Ning. Kunjungi kami di Jl. Ade Irma Suryani No.3 Malang."
        url="/tentang"
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 leading-relaxed mb-3">
                Anugerah Sports adalah toko peralatan olahraga yang telah berdiri sejak{' '}
                <strong className="text-gray-800">tahun 1974</strong> di Malang, Jawa Timur.
                Selama lebih dari 50 tahun kami telah melayani ribuan atlet dan pecinta olahraga
                dengan produk 100% original.
              </p>
              <p className="text-sm text-gray-500 leading-relaxed mb-4">
                Berlokasi di Jl. Ade Irma Suryani No.3, Klojen, Malang — kami adalah authorized
                distributor resmi Yonex, Victor, Li-Ning, dan brand terkemuka lainnya.
              </p>
